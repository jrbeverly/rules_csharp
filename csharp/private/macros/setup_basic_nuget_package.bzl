"""Rules for configuring nuget packages."""

load("//private:providers.bzl", "CSharpAssemblyInfo")
load("//private/rules:imports.bzl", "import_library", "import_multiframework_library")
